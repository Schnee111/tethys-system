...
export function LiveFeed() {
  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        {selectedEvent && (
          <motion.div
            ...
            style={{ overflow: 'hidden', background: 'rgba(255,255,255,0.05)', borderRadius: 12, textAlign: 'left' }}
          >
            <div style={{ padding: 16, display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                <span style={{
                  ...
                  background: 'rgba(255,255,255,0.1)', textTransform: 'uppercase',
      ...
      {/* Telemetry */}
      <div style={{ paddingTop: 12, fontFamily: 'var(--font-mono)', fontSize: 9, color: '#71717a', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
